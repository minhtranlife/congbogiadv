...
@section('custom-script')
    <script>
        $(function(){
            ...
            $('#select_kk, #select_hang,#select_cskd').change(function() {
                var current_path_url = '/dich-vu-luu-tru?';
                var kekhai =  '&kekhai='+$('#select_kk').val();
                if($(this).attr('id') == 'select_hang'||  $(this).attr('id') == 'select_kk'){
                    $('#select_cskd').val('all');
                }
                var hang = '';
                ...
                if($('#select_cskd').length > 0 ){
                    var cskd = '&cskd='+$('#select_cskd').val();
                }
                var url = current_path_url+kekhai+hang+cskd;
