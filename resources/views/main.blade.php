                ...
                <ul id="side-menu" class="nav">
                    ...
                    <li id="navhethong"><a href="{{url('')}}"><i class="fa fa-gears fa-fw"></i><span class="menu-title">Quản trị hệ thống</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                            <li><a href="{{url('')}}"><i class="fa fa-file-text"></i><span class="submenu-title">Danh mục loại giá</span></a> </li>

                            <li><a href="{{url('')}}"><i class="fa fa-file-text"></i><span class="submenu-title">Danh mục loại mặt hàng</span></a> </li>

                            <li><a href="{{url('')}}"><i class="fa fa-file-text"></i><span class="submenu-title">Danh mục thời điểm</span></a> </li>
                ...
                <ol class="breadcrumb page-breadcrumb pull-right">
                    <li class="btn btn-info btn-xs mbs">
                        ...
                        <i class="fa fa-calendar"></i>&nbsp;<b>
                            Ngày {{$now["mday"]}} tháng {{$now["mon"]}} năm {{$now["year"]}}
                           </b>&nbsp;&nbsp;
                    </li>
