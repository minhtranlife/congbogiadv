    ...
    <script>
        $(function(){
            ...
            $('#select_ma').change(function() {
                ...
                var url = '/dich-vu-van-tai-xe-buyt/'+ma;
    ...
    <div class="row">
        ...
        @foreach($dnvt as $dn)
            <div class="col-md-3 portfolio-item">
                <a href="{{url('dn-dich-vu-van-tai-xe-buyt/'.$dn->masothue)}}">
                    @if($dn->toado != null)
                ...
                <h3><a href="{{url('dn-dich-vu-van-tai-xe-buyt/'.$dn->masothue)}}">{{$dn->tendonvi}}</a></h3>
