...
@section('content')
    ...
    @else
        <h3>Đơn vị cung cấp dịch vụ vận tải chở khách chưa có kê khai giá gần nhất cho  {{$modeldvql->tendv}}</h3>
    @endif
    ...
    <div class="row">
        ...
        <div class="col-md-3 portfolio-item">
            <a href="{{url('dn-dich-vu-van-tai-xe-khach/'.$dnk->masothue)}}">
                @if($dnk->toado != null)
                    <img class="img-responsive"
                         src="https://maps.googleapis.com/maps/api/staticmap?zoom=17&amp;size=750x425&amp;sensor=false&amp;
            ...
            <h3><a href="{{url('dn-dich-vu-van-tai-xe-khach/'.$dnk->masothue)}}">{{$dnk->tendonvi}}</a></h3>
